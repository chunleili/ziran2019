...
template <class Simulation, int dim> class GlobalSystem {
public:
  ...
  template <class Func> void setMultiplier(Func multiply_func) {
  ...
  template <class Func> void setResidual(Func residual_func) {
