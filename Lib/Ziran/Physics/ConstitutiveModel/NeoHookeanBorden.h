...
template <class T, int dim> struct NeoHookeanBordenScratch {
  ...
  NeoHookeanBordenScratch() : F(TM::Identity()) {}

  static const char *name() { return "NeoHookeanBordenScratch"; }
};

template <class T, int _dim>
class NeoHookeanBorden
    : public HyperelasticConstitutiveModel<NeoHookeanBorden<T, _dim>> {
public:
  ...
  using Scratch =
      typename HyperelasticTraits<NeoHookeanBorden<T, dim>>::ScratchType;
...
template <class T, int dim> struct RW<NeoHookeanBordenScratch<T, dim>> {
