...
template <class, int dim, class enable = void> class SvdBasedIsotropicHelper;
...
public:
  ...
  SvdBasedIsotropicHelper(T a) : psi0(a), psi00(a) {}

  ~SvdBasedIsotropicHelper() {}

  void computePHat(TV &P_hat) const { P_hat(0) = psi0; }
...
public:
  ...
  SvdBasedIsotropicHelper(T a)
      : psi0(a), psi1(a), psi00(a), psi01(a), psi11(a), m01(a), p01(a) {}
...
public:
  ...
  SvdBasedIsotropicHelper(T a)
      : psi0(a), psi1(a), psi2(a), psi00(a), psi11(a), psi22(a), psi01(a),
        psi02(a), psi12(a), m01(a), p01(a), m02(a), p02(a), m12(a), p12(a) {}
