...
template void
eigenSparseLUSolve<double>(const Eigen::SparseMatrix<double, Eigen::RowMajor> &,
                           Eigen::Map<const Vector<double, Eigen::Dynamic>>,
                           Eigen::Map<Vector<double, Eigen::Dynamic>>);
template void
eigenSparseLUSolve<float>(const Eigen::SparseMatrix<float, Eigen::RowMajor> &,
                          Eigen::Map<const Vector<float, Eigen::Dynamic>>,
                          Eigen::Map<Vector<float, Eigen::Dynamic>>);
} // namespace ZIRAN
