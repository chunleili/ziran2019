...
template <class T, int m, int n>
inline void GivensQR(const Matrix<T, m, n> &A, Matrix<T, m, m> &Q,
                     Matrix<T, m, n> &R) {
  R = A;
  inplaceGivensQR(R, Q);
}
...
template <class T, int m, int n>
inline void thinGivensQR(const Eigen::Matrix<T, m, n, 0, m, n> &A,
                         Eigen::Matrix<T, m, n, 0, m, n> &Q0,
                         Eigen::Matrix<T, n, n, 0, n, n> &R0) {
