...
template void writeNode<float, 2>(std::ostream &os,
                                  const StdVector<Vector<float, 2>> &faces);
template void writeNode<float, 3>(std::ostream &os,
                                  const StdVector<Vector<float, 3>> &faces);
template void writeNode<double, 2>(std::ostream &os,
                                   const StdVector<Vector<double, 2>> &faces);
template void writeNode<double, 3>(std::ostream &os,
