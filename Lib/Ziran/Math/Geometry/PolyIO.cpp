...
template void readSegmeshPoly<double, 2>(
    std::string const &,
...
template void readSegmeshPoly<double, 3>(
    std::string const &,
    ...
    std::vector<Eigen::Matrix<int, 2, 1, 0, 2, 1>,
                Eigen::aligned_allocator<Eigen::Matrix<int, 2, 1, 0, 2, 1>>> &);
template void readSegmeshPoly<float, 2>(
    std::string const &,
    ...
    std::vector<Eigen::Matrix<int, 2, 1, 0, 2, 1>,
                Eigen::aligned_allocator<Eigen::Matrix<int, 2, 1, 0, 2, 1>>> &);
template void readSegmeshPoly<float, 3>(
    std::string const &,
