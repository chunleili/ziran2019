...
void barycentricWeights(const Vector<T, dim> &p, const Vector<T, dim> &a,
                        const Vector<T, dim> &b, const Vector<T, dim> &c,
                        Vector<T, 3> &weights) {
...
*/
template <class T, int dim>
void interiorBarycentricWeights(const Vector<T, dim> &p,
...
template void interiorBarycentricWeights<double, 3>(
    Eigen::Matrix<double, 3, 1, 0, 3, 1> const &,
    Eigen::Matrix<double, 3, 1, 0, 3, 1> const &,
    Eigen::Matrix<double, 3, 1, 0, 3, 1> const &,
    Eigen::Matrix<double, 3, 1, 0, 3, 1> const &,
    Eigen::Matrix<double, 3, 1, 0, 3, 1> &);
template void interiorBarycentricWeights<float, 3>(
...
template void
barycentricWeights<double, 3>(Eigen::Matrix<double, 3, 1, 0, 3, 1> const &,
                              Eigen::Matrix<double, 3, 1, 0, 3, 1> const &,
                              Eigen::Matrix<double, 3, 1, 0, 3, 1> const &,
                              Eigen::Matrix<double, 3, 1, 0, 3, 1> const &,
                              Eigen::Matrix<double, 3, 1, 0, 3, 1> &);
template void
barycentricWeights<float, 3>(Eigen::Matrix<float, 3, 1, 0, 3, 1> const &,
                             Eigen::Matrix<float, 3, 1, 0, 3, 1> const &,
                             Eigen::Matrix<float, 3, 1, 0, 3, 1> const &,
                             Eigen::Matrix<float, 3, 1, 0, 3, 1> const &,
                             Eigen::Matrix<float, 3, 1, 0, 3, 1> &);

template void interiorBarycentricWeights<double, 2>(
    Eigen::Matrix<double, 2, 1, 0, 2, 1> const &,
    Eigen::Matrix<double, 2, 1, 0, 2, 1> const &,
    Eigen::Matrix<double, 2, 1, 0, 2, 1> const &,
    Eigen::Matrix<double, 2, 1, 0, 2, 1> const &,
    Eigen::Matrix<double, 3, 1, 0, 3, 1> &);
template void interiorBarycentricWeights<float, 2>(
    ...
    Eigen::Matrix<float, 3, 1, 0, 3, 1> &);
template void
barycentricWeights<double, 2>(Eigen::Matrix<double, 2, 1, 0, 2, 1> const &,
                              Eigen::Matrix<double, 2, 1, 0, 2, 1> const &,
                              Eigen::Matrix<double, 2, 1, 0, 2, 1> const &,
                              Eigen::Matrix<double, 2, 1, 0, 2, 1> const &,
                              Eigen::Matrix<double, 3, 1, 0, 3, 1> &);
template void
barycentricWeights<float, 2>(Eigen::Matrix<float, 2, 1, 0, 2, 1> const &,
                             Eigen::Matrix<float, 2, 1, 0, 2, 1> const &,
                             Eigen::Matrix<float, 2, 1, 0, 2, 1> const &,
                             Eigen::Matrix<float, 2, 1, 0, 2, 1> const &,
                             Eigen::Matrix<float, 3, 1, 0, 3, 1> &);
