...
public:
  ...
  bool operator==(const Double &x) const { return val == x.val; }

  bool operator!=(const Double &x) const { return !(*this == x); }
...
inline Double operator+(const double &x, const Double &y) { return y + x; }
...
inline Double sqrt(const Double &x) { return Double(std::sqrt(x.val)); }
...
inline Double abs(const Double &x) { return Double(std::abs(x.val)); }

inline Double abs2(const Double &x) { return x * x; }

inline Double fabs(const Double &x) { return Double(std::fabs(x.val)); }
