...
class ScopedTimer {
public:
  ScopedTimer(const std::string &function_name, const std::string &file,
              int line_number, bool print_now = true);
...
#define ZIRAN_TIMER()                                                          \
  ScopedTimer ziran_timer(__func__, __FILE__, __LINE__, true)
#define ZIRAN_QUIET_TIMER()                                                    \
  ScopedTimer ziran_timer(__func__, __FILE__, __LINE__, false)
