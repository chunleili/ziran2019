...
const std::map<int, std::string> kSignals = {
    {SIGINT, "SIGINT"}, {SIGABRT, "SIGABRT"}, {SIGFPE, "SIGFPE"},
    {SIGILL, "SIGILL"}, {SIGSEGV, "SIGSEGV"}, {SIGTERM, "SIGTERM"},
};
...
void restoreSignalHandlerToDefault() { overrideSetupSignals(kSignals); }
} // namespace ZIRAN
