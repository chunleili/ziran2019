...
#define ZIRAN_DEBUG_FUNCTION_NAME                                              \
  ((const char *)__FUNCTION__) // cast to const char* to work around error in
                               // noreturn
/**
...
#define ZIRAN_ASSERT(condition, ...)                                           \
  if (condition) {                                                             \
    ...
    ZIRAN::DEBUG_UTILITIES::assertionFailed(ZIRAN_DEBUG_FUNCTION_NAME,         \
...
assertionFailed(const char *function, const char *file, unsigned int line,
...
[[noreturn]] inline void assertionFailed(const char *function, const char *file,
                                         unsigned int line,
